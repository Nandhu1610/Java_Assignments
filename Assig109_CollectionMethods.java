...
//WAP to Demonstrate Collection Methods: addAll(), clear(), contains(), 
//containsAll(), equals(), isEmpty(), iterator(), and remove(), removeAll(), and size()
public class Assig109_CollectionMethods 
{
